                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_pinjam" name="tanggal_pinjam" value="<?php echo $tanggal_pinjam; ?>" required>
                            </div>
                            <div class="form-group mb-5">
                                <label for="tanggal_kembali">Tanggal Kembali</label>
                                <input type="date" class="form-control" id="tanggal_kembali" name="tanggal_kembali" value="<?php echo $tanggal_kembali; ?>" required>
                            </div>
